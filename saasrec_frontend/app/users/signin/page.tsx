...
export default function UserSignInPage() {
  ...
  const handleSubmit = (e: React.FormEvent) => {
    ...
    navigate("/users/dashboard/clubs")
  }
      ...
      <main className="flex-1 flex items-center justify-center p-6">
        <div className="w-full max-w-md bg-white/95 backdrop-blur-xl border border-white/20 shadow-2xl rounded-lg p-8">
          <div className="space-y-2 mb-6">
            <h1 className="text-2xl font-bold text-purple-900">Member Sign In</h1>
            <p className="text-purple-600">Sign in to browse clubs and register for activities</p>
          </div>
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <div className="text-sm text-center text-purple-700">
              ...
              <a href="/users/dashboard/subscription" className="text-purple-900 hover:underline font-semibold">
                Sign Up
              </a>
            </div>
          </form>
