      ...
      <main className="flex-1 flex items-center justify-center p-6">
        <div className="w-full max-w-md bg-white/95 backdrop-blur-xl border border-white/20 shadow-2xl rounded-lg p-8">
          <div className="space-y-2 mb-6">
            <h1 className="text-2xl font-bold text-primary">Member Sign In</h1>
            <p className="text-primary">Sign in to browse clubs and register for activities</p>
          </div>
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <div className="text-sm text-center text-primary">
              ...
              <a href="/users/dashboard/subscription" className="text-primary hover:underline font-semibold">
                Sign Up
              </a>
            </div>
          </form>
