    ...
    <ClubDashboardLayout>
      <div className="p-6">
        <div className="max-w-4xl mx-auto space-y-6">
          {/* Page Header */}
          <div>
            <h1 className="text-3xl font-bold text-primary mb-2">Club Setup</h1>
            <p className="text-primary">Configure your club's profile and settings</p>
          </div>

          {/* Success Banner */}
          <div className="bg-gradient-to-r from-green-50 to-emerald-50 border border-green-200 rounded-lg p-4">
            <div className="flex items-center gap-2">
              <div className="w-5 h-5 bg-secondary/200 rounded-full flex items-center justify-center text-white text-xs">✓</div>
              <p className="text-primary font-medium">Success! Your club is set up and ready to go.</p>
            </div>
          </div>
          ...
          <Card className="border-primary/20 shadow-lg">
            <CardHeader className="bg-gradient-to-r from-purple-50 to-pink-50 border-b border-primary/20">
              <CardTitle className="text-primary">Registration Settings</CardTitle>
              <CardDescription className="text-primary">Control whether new users can register for activities</CardDescription>
            </CardHeader>
            <CardContent className="pt-6">
              <div className="flex items-center justify-between">
                <div className="space-y-1">
                  <Label htmlFor="registration-toggle" className="text-base font-medium text-primary">
                    User Registration
                  </Label>
